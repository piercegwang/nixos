{
  ...
  outputs = inputs @ {self, nixpkgs, nixpkgs-2305-stable, nixpkgs-2411-stable, home-manager, nixos-hardware, ...}:
    ...
    in                                                                      # Use above variables in ...
      {
        ...
        nixosConfigurations = (
         import ./hosts {
            inherit (nixpkgs) lib;
            inherit inputs outputs user nixpkgs nixpkgs-2305-stable nixpkgs-2411-stable home-manager nixos-hardware;
          }
        );
      };
}
